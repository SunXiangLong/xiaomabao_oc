...
- (void)setUpChildVcs{
    MBMaoBaoCardViewController *VC1 =   [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"MBMaoBaoCardViewController"];
    VC1.title = @"麻包卡&共享卡";
    [self addChildViewController:VC1];
    
    MBWelfareCardViewController *VC2 = [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"MBWelfareCardViewController"];
    VC2.title = @"福利卡";
