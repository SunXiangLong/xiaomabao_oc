...
- (void)setUpChildVcs{
    MBMaoBaoEntityCardViewController *VC1 =   [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"MBMaoBaoEntityCardViewController"];
    [self addChildViewController:VC1];
    
    MBMaoBaoElectronicCardViewController *VC2 = [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"MBMaoBaoElectronicCardViewController"];
