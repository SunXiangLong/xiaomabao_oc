...
//  XiaoMaBao
//
//  Created by xiaomabao on 2016/11/11.
...
@interface MBSearchViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
{
    MBProgressHUD *HUD;
}
