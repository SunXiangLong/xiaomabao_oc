...
@interface MBWelfareCardViewController ()
{
    NSInteger _page;
}
...
@implementation MBWelfareCardViewController
...
-(void)requestData{
    ...
    [self show];
    [MBNetworking newGET:string(BASE_URL_root, string(@"/giftcard/welfare_card/", s_Integer(_page))) parameters:nil success:^(NSURLSessionDataTask *task, id responseObject) {
        [self dismiss];
