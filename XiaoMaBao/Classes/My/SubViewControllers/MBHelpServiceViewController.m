...
@interface MBHelpServiceViewController ()
@end

@implementation MBHelpServiceViewController
...
- (void)viewDidLoad {
    ...
    NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"help" ofType:@"html" inDirectory:@"www"]];
