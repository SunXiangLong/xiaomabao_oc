...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        self.backgroundColor = RGBACOLOR(247, 247, 247, 0.9);
...
- (void)layoutSubviews {
    ...
    self.textView.frame = CGRectMake(10.0f, 12.0f, UISCREEN_WIDTH - 55.0f, self.bounds.size.height - 24.0f);
    self.placeholderLabel.frame = CGRectMake(15.0f, 12.0f, UISCREEN_WIDTH - 55.0f, self.bounds.size.height - 24.0f);
    self.emojiButton.frame = CGRectMake(UISCREEN_WIDTH - 40.0f, 4.5f, 35.0f, 35.0f);
}
...
- (void)textView:(AutoFitSizeTextView *)textView heightChanged:(NSInteger)height {
    ...
    if (self.frame.size.height <= 100.0f &&
        self.frame.origin.y != UISCREEN_HEIGHT &&
...
- (UIButton *)emojiButton {
    ...
    [_emojiButton setImage:[UIImage imageNamed:@"postCamera_image"] forState:UIControlStateNormal];
    return _emojiButton;
}
