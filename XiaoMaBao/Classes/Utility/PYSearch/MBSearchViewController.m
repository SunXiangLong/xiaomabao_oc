...
@interface MBSearchViewController () <UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource>
/** 头部内容view */
...
{
    MBSearchViewController *searchVC = [self searchViewControllerWithHotSearches:hotSearches searchBarPlaceholder:placeholder];
...
- (void)setup
{
    ...
    titleView.py_y = 7;
    titleView.py_width = UISCREEN_WIDTH - 64 - titleView.py_x * 2;
...
- (UILabel *)setupTitleLabel:(NSString *)title
{
    ...
    titleLabel.py_x = 0;
    titleLabel.py_y = 0;
    titleLabel.py_width = PYScreenW - 30;
    return titleLabel;
}
...
- (void)setupHotSearchRankTags
{
    ...
    for (int i = 0; i < self.hotSearches.count; i++) {
        ...
        rankTag.backgroundColor = [UIColor py_colorWithHexString:self.rankTagBackgroundColorHexStrings[i % self.rankTagBackgroundColorHexStrings.count]];
        ...
        //        switch (i) {
        //            case 0: // 第一名
        //                rankTag.backgroundColor = [UIColor colorWithHexString:self.rankTagBackgroundColorHexStrings[0]]; //[UIColor py_colorWithHexString:self.rankTagBackgroundColorHexStrings[0]];
        //                rankTag.textColor = [UIColor whiteColor];
        //                break;
        //            case 1: // 第二名
...
- (void)setRankTagBackgroundColorHexStrings:(NSArray<NSString *> *)rankTagBackgroundColorHexStrings
{
    ...
    //        NSArray *colorStrings = @[@"#7ecef4", @"#84ccc9", @"#88abda",@"#7dc1dd",@"#b6b8de"];//@[@"#f14230", @"#ff8000", @"#ffcc01", @"#ebebeb"];
    ...
    //    }
    _rankTagBackgroundColorHexStrings = rankTagBackgroundColorHexStrings;
    // 刷新
...
- (UILabel *)labelWithTitle:(NSString *)title
{
    ...
    label.backgroundColor = PYColorPolRandomColor;
...
{
    MMLog(@"%lu",(unsigned long)searchText.length);
    if (searchText.length == 0) {
        [self.view bringSubviewToFront:self.baseSearchTableView];
    }
    //    // 根据输入文本显示建议搜索条件
