...
@interface MBRegisterViewController () <UIAlertViewDelegate>
...
-(void)xieyi{
    ...
    helpVC.title = @"服务条款";
    helpVC.url =  [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"service_provision" ofType:@"html"]];
