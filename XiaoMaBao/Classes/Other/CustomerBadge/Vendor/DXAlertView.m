...
#define kAlertWidth (UISCREEN_WIDTH-100)
#define kAlertHeight (UISCREEN_WIDTH-100)*2/3
   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        self.alertTitleLabel.textAlignment =1;
        [self addSubview:self.alertTitleLabel];
        
        
        
        CGFloat contentLabelWidth = kAlertWidth - 50;
        self.alertContentLabel = [[UILabel alloc] initWithFrame:CGRectMake((kAlertWidth - contentLabelWidth) * 0.5, CGRectGetMaxY(self.alertTitleLabel.frame), contentLabelWidth, kAlertHeight - 90)];
        self.alertContentLabel.numberOfLines = 0;
        self.alertContentLabel.textAlignment = 0;
...
#define kSingleButtonWidth  (kAlertWidth/2-30)
#define kCoupleButtonWidth  (kAlertWidth/2-30)
#define kButtonHeight      (kAlertWidth/2-30)/4
#define kButtonBottomOffset 10.0f
        if (!leftTitle) {
            rightBtnFrame = CGRectMake(kAlertWidth-10-kSingleButtonWidth, kAlertHeight - kButtonBottomOffset - kButtonHeight, kSingleButtonWidth, kButtonHeight);
            self.rightBtn = [UIButton buttonWithType:UIButtonTypeCustom];
            self.rightBtn.frame = rightBtnFrame;
            
        }else {
            leftBtnFrame = CGRectMake(10, kAlertHeight - kButtonBottomOffset - kButtonHeight, kCoupleButtonWidth, kButtonHeight);
            rightBtnFrame = CGRectMake(kAlertWidth-10-kCoupleButtonWidth, kAlertHeight - kButtonBottomOffset - kButtonHeight, kCoupleButtonWidth, kButtonHeight);
...
//       
//        NSInteger num = (UISCREEN_WIDTH-50)*2/3;
//        //NSInteger top = (UISCREEN_HEIGHT - num)/2-num/2;
//        make.left.mas_equalTo(50);
//        make.right.mas_equalTo(-50);
//        make.height.mas_equalTo(num);
//        make.centerY.equalTo(topVC.view.mas_centerY).offset(0);
//    }];
}
