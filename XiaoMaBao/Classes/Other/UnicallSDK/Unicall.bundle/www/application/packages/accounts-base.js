...
Ap._initLocalStorage = function () {                                                                                 // 91
  ...
  self.LOGIN_TOKEN_KEY = "Meteor.loginToken:livechat";                                                               // 95
  self.LOGIN_TOKEN_EXPIRES_KEY = "Meteor.loginTokenExpires:livechat";                                                // 96
  self.USER_ID_KEY = "Meteor.userId:livechat";                                                                       // 97
                                                                                                                     //
