...
import AVFoundation
import MJRefresh
class MBChatVC: BkBaseViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if isGroup {
            ...
            self.titleStr = group.displayName()
        }
    }
...
extension MBChatVC: JMessageDelegate {
...
extension MBChatVC: JCEmoticonInputViewDataSource, JCEmoticonInputViewDelegate {
...
extension MBChatVC: SAIToolboxInputViewDataSource, SAIToolboxInputViewDelegate {
...
extension MBChatVC: YHPhotoPickerViewControllerDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
...
extension MBChatVC: JCMessageDelegate {
...
extension MBChatVC: JCChatViewDelegate {
...
extension MBChatVC: UIAlertViewDelegate {
...
extension MBChatVC: SAIInputBarDelegate, SAIInputBarDisplayable {
...
extension MBChatVC: JChatRecordVoiceHelperDelegate {
