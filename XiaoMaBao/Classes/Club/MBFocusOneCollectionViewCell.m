//
//  MBFocusOneCollectionViewCell.m
//  XiaoMaBao
//
...
@implementation MBFocusOneCollectionViewCell
...
-(void)setprase:(NSArray *)prase image:(NSArray *)imagaeArr{
    ...
    [self.bootomView addSubview:view];
    
    NSMutableArray *imagearr = [NSMutableArray array];
    for (NSDictionary *dic in imagaeArr) {
        [imagearr addObject:dic[@"origin"]];
    }
    
        MBLevelDisplayImagesView *view1 = [[MBLevelDisplayImagesView alloc] initWithFrame:CGRectMake(0, 0, UISCREEN_WIDTH-20, 40)];
        view1.width = 80;
        view1.height = 40;
    view1.urlImageArray = imagearr;
    
     [self.centenView addSubview:view1];
