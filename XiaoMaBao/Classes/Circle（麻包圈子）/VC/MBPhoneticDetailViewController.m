...
- (void)loadData{
    [self show];
    [MBNetworking POSTOrigin:string(BASE_URL_root, @"/voice/voice_detail") parameters:@{@"id":_ID} success:^(id responseObject) {
        [self dismiss];
        MMLog(@"%@",responseObject);
        MBPhoneticDetailTableViewController  *VC =  [[UIStoryboard storyboardWithName:@"Circle" bundle:nil] instantiateViewControllerWithIdentifier:@"MBPhoneticDetailTableViewController"];
